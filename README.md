...
Automatic insights on upload — the agent proactively points out what stands out in the data before you ask anything
...
On-demand charts — bar, line, and histogram charts, with fuzzy column matching so typos or wrong casing still work
Multi-chat sidebar — like a ChatGPT-style interface: create multiple chats, each with its own dataset and history, rename or delete any of them
